...
<p align="center">
  <img src="docs/eval_pipeline.svg" alt="RegSentinel evaluation pipeline: four layers — unit and guardrail (no API key, gate every push) followed by agent and end-to-end (need an API key) — all rolled up in GitHub Actions." width="100%">
</p>

<p align="center"><sub><b>Figure 2.</b> Four eval layers, cheapest-and-most-deterministic first. Vector source: <a href="docs/eval_pipeline.svg"><code>docs/eval_pipeline.svg</code></a>.</sub></p>
